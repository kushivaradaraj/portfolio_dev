(function () {
  ...
  function Y(a, b, c, d) {
    c.href &&
      ((a = V(a, b, c.href, void 0 === d ? !1 : d)), x.test(a) && (c.href = a));
  }
  function X(a, b, c) {
    if (c && c.action) {
  ...
  var td = function (a, b) {
      ...
      if ("cookie" == P(a, ac)) {
        ...
        a.get(je) &&
          !a.get(Se) &&
          ((c = {}),
          (d = (M ? df(c, "_gac_gb", !0) : {})[P(a, Na)]),
          ef(c),
          d &&
            0 != d.length &&
            ((c = d[0]),
            (d = c.qa),
            c.labels && c.labels.length && (d += "." + c.labels.join(".")),
            a.data.set(Te, c.timestamp / 1e3),
            a.data.set(Se, d)));
      }
      if (a.get(Hd)) {
        c = be("_ga", !!a.get(cc));
